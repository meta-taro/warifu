...
| Phase | 内容 | v2 の対応章 | 備考 |
|---|---|---|---|
| 2 | P2P Text / Connection Request / Rate Limit / Spam Defense / **File Quarantine** | v2 §11 §12 | **Relay 自社運用はここまで行わない**（D3）。**File Quarantine は v2 で新規**（受信 File を Downloads へ直接置かず検査。**Trusted からの File も Zero Trust**）。**2026-09-02: File Quarantine は `warifu-quarantine` として動いている**（20 件 green・**D30**）。残りは P2P Text / Connection Request / Rate Limit / Spam Defense |
