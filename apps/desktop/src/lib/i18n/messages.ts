...
export const MESSAGES: Record<Locale, Record<MessageKey, string>> = {
  ja: {
    ...
    'chat.desk': 'マイ PC エージェントが居ます。部屋に人が居なくても話しかけられます。',
  ...
  en: {
    ...
    'chat.desk': 'An agent on this computer is here. You can talk to it even with nobody else in the room.',
  ...
  zh: {
    ...
    'chat.agent': '我的电脑代理',
    'chat.desk': '这台电脑的代理在。即使房间里没有其他人，也可以对它说话。',
  ...
  ko: {
    ...
    'chat.desk': '이 PC 의 에이전트가 있습니다. 방에 사람이 없어도 말을 걸 수 있습니다.',
