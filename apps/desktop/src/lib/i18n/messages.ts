...
export const MESSAGES: Record<Locale, Record<MessageKey, string>> = {
  ja: {
    ...
    'chat.late': '留守中',
    'send.absent': 'いま届きません。預かり所を置くと、留守中でも届きます。',
    ...
    'home.contacts': '覚えている相手',
    'home.postbox': '預かり所',
    'home.postbox.on': '置いてあります',
    'home.postbox.off': '置いていません',
    ...
    'act.chat': 'チャット',
    'act.chat.live': '繋がっている間だけ届きます。相手が起動していないときは、打ったものはどこにも残りません。預かり所を置くと、留守のときも預けられます。',
    'act.chat.postbox': 'この相手とだけの会話です。相手が留守のときは、預かり所へ封のまま預けます（7 日）。',
  ...
  en: {
    ...
    'home.contacts': 'People remembered',
    'home.postbox': 'Poste restante',
  ...
  ko: {
    ...
    'home.contacts': '기억하고 있는 상대',
    'home.postbox': '보관소',
    'home.postbox.on': '두었습니다',
    'home.postbox.off': '두지 않았습니다',
