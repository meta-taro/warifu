...
export const MESSAGES: Record<Locale, Record<MessageKey, string>> = {
  ja: {
    ...
    'reunion.call': '連絡先から呼べます（鍵は要りません）。ただし相手の側でも覚えていないと、呼んでも通りません。',
    'reunion.wait': 'こちらからは呼べません（居場所を知りません）。相手から呼んでもらえば通ります。',
    'reunion.key': '初回と同じで、鍵を渡し合います。次から鍵なしにしたいなら、名前の隣の鉛筆で呼び名を付けてください。',
  ...
  zh: {
    ...
    'reunion.title': '下次见面时',
    'reunion.call': '可以从联系人里呼叫（不需要钥匙）。但对方也要记住你，否则呼叫不会通。',
    'reunion.wait': '你无法呼叫对方（不知道对方在哪）。如果对方来呼叫你，就能通。',
    'reunion.key': '和第一次一样，互相交换钥匙。想让下次不需要钥匙，请用名字旁边的铅笔起个称呼。',
