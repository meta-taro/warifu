<script lang="ts" module>
  ...
  const PATHS: Record<IconName, string[]> = {
    // 連絡帳（開いた帳面）
    book: ['M4 5a2 2 0 0 1 2-2h5v18H6a2 2 0 0 1-2-2z', 'M20 5a2 2 0 0 0-2-2h-5v18h5a2 2 0 0 0 2-2z'],
    // 予定（暦）
    ...
    // 鉛筆（名前を書き換える）
    pencil: ['M4 20h4L19 9a2.1 2.1 0 0 0-3-3L5 17z', 'M14.5 6.5l3 3'],
    // 預かり所（受け取り箱。**中身は読めない**ので、閉じた形にする）
    postbox: ['M4 10a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z', 'M8 8V6a4 4 0 0 1 8 0v2', 'M4 14h16'],
    // この機械（マイ PC エージェント がつながっている所）
    desk: ['M3 9h18', 'M5 9V6a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3', 'M6 9v10', 'M18 9v10'],
