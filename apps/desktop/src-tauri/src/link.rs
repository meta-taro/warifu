...
pub fn 鍵を取り出す(url: &str) -> Option<String> {
    ...
    // 会議キーは `WARIFU1-<宛先>#<割符>#<部屋>` の形なので、これに当たる
...
///
/// 会議キーは宛先と割符と部屋を含むので長い（実測で 380 字ほど）。
